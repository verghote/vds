...
-- Date: Tue, 06 May 2025 14:37:31 +0200
...
SET autocommit=0;
INSERT INTO `traficip` VALUES ('::1','2025-05-06 12:33:38','/backoffice/'),('::1','2025-05-06 12:36:54','/backoffice/sauvegarde/'),('::1','2025-05-06 12:37:31','/backoffice/sauvegarde/sauvegarder.php');
/*!40000 ALTER TABLE `traficip` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;

-- Dumped table `traficip` with 3 row(s)
--
...
-- Dump completed on: Tue, 06 May 2025 14:37:31 +0200
